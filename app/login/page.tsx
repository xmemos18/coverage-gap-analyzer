...
export default function LoginPage() {
  ...
  const handleTogglePassword = () => {
    // Show NDA when trying to view password
    if (!ndaAccepted) {
      setShowNDA(true);
    } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Show NDA before allowing login
    if (!ndaAccepted) {
      setShowNDA(true);
      return;
    }
    ...
    if (password === CORRECT_PASSWORD) {
      ...
      document.cookie = `auth=authenticated; path=/; max-age=${60 * 60 * 24}`; // 24 hours
          ...
          <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-premium dark:shadow-glow-blue p-8 border border-gray-200 dark:border-dark-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 dark:bg-dark-900 border border-gray-300 dark:border-dark-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent text-gray-900 dark:text-gray-100 transition-all"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg shadow-md transition-all duration-200"
              >
                Access System
              </motion.button>
            </form>
