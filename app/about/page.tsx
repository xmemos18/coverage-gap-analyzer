export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-primary mb-8">About Coverage Gap Analyzer</h1>
      <div className="prose prose-lg max-w-none">
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
          Coverage Gap Analyzer solves a problem affecting millions: finding health insurance that covers you when you own homes in multiple states.
        </p>
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
