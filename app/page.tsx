...
export default function Home() {
  return (
    <div className="bg-white dark:bg-dark-950">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-blue-50 dark:from-dark-900 to-white dark:to-dark-950 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-blue-900 dark:text-blue-400 mb-6 leading-tight">
          ...
          <Link
            href="/calculator"
            className="inline-block bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-bold text-lg px-10 py-4 rounded-lg shadow-lg transition-all transform hover:scale-105"
          >
            Analyze My Coverage
          </Link>
        </div>
      ...
      <section className="bg-gray-50 dark:bg-dark-900 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              <div className="flex-shrink-0 bg-blue-600 dark:bg-blue-500 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold">
                1
              </div>
              <div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-center">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-8 border border-green-100 dark:border-green-800">
      ...
      {/* FAQ Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-dark-950">
        <div className="max-w-4xl mx-auto">
