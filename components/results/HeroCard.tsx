    ...
    <div className="relative overflow-hidden bg-white dark:bg-dark-800 rounded-3xl border-2 border-gray-200 dark:border-dark-700 shadow-xl p-8 md:p-10 mb-8 md:mb-10">
      ...
      <div className="relative flex flex-col md:flex-row md:items-center md:gap-10">
        ...
        <div className="flex-1 text-center md:text-left">
          {/* Recommended Badge */}
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-xs font-semibold uppercase rounded-full mb-4">
          ...
          {planCategory && (
            <div className="mb-3">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-semibold bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-700">
