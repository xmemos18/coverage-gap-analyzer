                ...
                <div>
                  ...
                  >
                    ...
                    {!isValidating && isValid === true && (
                      <span className="text-green-600 text-sm font-semibold" aria-label="Valid ZIP code">✓ Valid</span>
                    )}
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-2 pr-10 border rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 ${
                    ...
                    {!isValidating && isValid === true && (
                      <span className="absolute right-3 top-2.5 text-green-600 text-xl" aria-hidden="true">✓</span>
                    )}
                    {!isValidating && isValid === false && residence.zip.length === 5 && (
                ...
                <div>
                  ...
                  >
                    ...
                    {residence.state && !stateError && (
                      <span className="text-green-600 text-sm" aria-label="Valid state selected">✓</span>
                    )}
                  </label>
                  <select
